...
public class UserController {
	...
	/*
	 * @GetMapping("/findByflightId/{id}") public ResponseEntity<Optional<Flight>>
	 * flightId(@PathVariable int flightId) { System.out.println(flightId);
	 * Optional<Flight> obj = flightService.findByflightId(flightId);
	 * System.out.println(obj); return new ResponseEntity<Optional<Flight>>(obj,
	 * HttpStatus.OK); }
	 */
